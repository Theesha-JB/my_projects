...
try(BufferedReader br = new BufferedReader(
    ...
    //	 String e=email.getText();
	   ...
	   FileOutputStream fileOut = new FileOutputStream("C:\\Users\\Darshan\\Documents\\SDM\\Attendance\\Workbook2.xls");
   	 ...
   	 if( password.getText().isEmpty()) {
    	 ...
    	 else if(e.endsWith("gmail.com") || e.endsWith("yahoo.com") ==false)
    	 {
    		 Alert alert = new Alert(AlertType.ERROR);
		    	alert.setTitle("Error Dialog");
		    	alert.setHeaderText("Look, an Error Dialog");
		    	alert.setContentText("Please enter proper email");

    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        tableview.setItems(data);
         ...
         if(tf.equalsIgnoreCase("rice"))
         {
        	 ...
        	 ImageView emp1photo = new ImageView(new Image(this.getClass().getResourceAsStream("india gate.jpg")));
             emp1photo.setFitHeight(115);
              emp1photo.setFitWidth(100);
              ImageView emp2photo = new ImageView(new Image(this.getClass().getResourceAsStream("jeera rice.jpg")));
              emp2photo.setFitHeight(115);
              emp2photo.setFitWidth(100);
              ImageView emp3photo = new ImageView(new Image(this.getClass().getResourceAsStream("steam.jpg")));
              emp3photo.setFitHeight(115);
              emp3photo.setFitWidth(100);
        	 
              Employee emp2 = new Employee(emp1photo, 115, "India Gate rice..the best there is.", "good refined sugar", "10 KG", 40000);
              Employee emp3 = new Employee(emp2photo, 116, "jeera rice for good tasting rice", "good jeera rice ", "20 kg", 80000);
              Employee emp4 = new Employee(emp3photo,117, "steam rice", "good quality", "80 kg", 80000);
